...
namespace GoogleLib.Tools
{
    ...
    {
        public const int NumberHouses = 6;
        public enum House
        {
            House_20_1,
            House_20_2,
        ...
        {
            0 => (20, 1, "20/1", "Пишоновская, 20/1"),
            1 => (20, 2, "20/2", "Пишоновская, 20/2"),
            2 => (22, 2, "22/2", "Пишоновская, 22/2"),
            3 => (24, 2, "24/2", "Пишоновская, 24/2"),
            4 => (26, 1, "26/1", "Пишоновская, 26/1"),
            5 => (26, 2, "26/2", "Пишоновская, 26/2"),
            _ => throw new ArgumentException("Недопустимый номер дом")
        };
