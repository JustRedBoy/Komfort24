...
namespace Desktop.Models
{
    public class PrintReport
    {
        ...
        public double ForRepair { get; set; }
        public double ForWater { get; set; }
        public double ForGarbage { get; set; }
        public double WerPayment { get; set; }
        public double RepairPayment { get; set; }
        ...
        public PrintReport(ArchiveReport2 report)
        {
            ...
            ForRepair = report.RepairForMonth;
            ForWater = report.WaterForMonth;
            ForGarbage = report.GarbageForMonth;
            ...
            RepairPayment = report.WerRepair;
